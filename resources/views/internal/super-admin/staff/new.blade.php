...
<div class="content-page">
  <div class="nk-block-head nk-block-head-lg wide-md">
      <div class="nk-block-head-content">
          ...
          <h3 class="nk-block-title fw-bold">Tambahkan Staff baru Anda</h3>
      </div>
  </div><!-- .nk-block-head -->
  <div class="nk-block">
      <div class="row">
              ...
              <div class="">
                <div class="nk-block nk-block-lg">
                  <form method="POST" action="{{ route('admin.staff.store') }}">
                      ...
                      <div class="mb-5">
                          <input name="name" placeholder="Contoh: nama pengguna" value="{{ old('name') }}" type="text" class="form-control form-control-lg">
                          @error('name')
                      ...
                      <div class="mb-5">
                        <input name="email" placeholder="Contoh: alamat email" value="{{ old('email') }}" type="email" class="form-control form-control-lg">
                        @error('email')
                        <span class="d-block text-danger mb-3 mt-1">{{ $message }}</span>
                        @enderror
                      </div>
                      ...
                      <div class="mb-5">
                        <div class="form-control-wrap">
                          <input name="employee_degree" placeholder="Contoh: S1 Teknik informatika" value="{{ old('employee_degree') }}" type="text" class="form-control form-control-lg">
                        </div>
                      ...
                      <button class="mt-5 btn btn-primary">Tambahkan pengguna</button>
                  </form>
